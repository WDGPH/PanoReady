...
export default function ReportsPage({ initialXml = "", onBack }: { initialXml?: string; onBack?: () => void } = {}) {
  ...
  return (
    ...
    >
      {onBack && <button type="button" className="btn btn-secondary" onClick={onBack} style={{ marginBottom: 16 }}>Back to Validate &amp; Fix</button>}
      <h1
        style={{
          fontSize: 22,
          fontWeight: 700,
